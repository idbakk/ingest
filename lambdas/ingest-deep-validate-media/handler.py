...
# FFPROBE Helper
def select_probe_candidate(classified_entries: List[Dict[str, Any]]) -> Optional[Dict[str, Any]]:
...
def download_s3_to_tmp(bucket: str, key: str) -> str:
    filename = os.path.basename(key) or "probe.bin"
...
def handler(event, context):
    ...
    probe_candidate = select_probe_candidate(result["classified_entries"])
